...
public partial class PhotoViewerPage : ContentPage
{
    ...
    private static string GetLogPath() => AppLog.DefaultLogPath;
    ...
    private async void OnSaveClicked(object sender, EventArgs e)
    {
        ...
        {
            AppLog.Error(GetLogPath(), LogCategories.RuntimeError, nameof(PhotoViewerPage), nameof(OnSaveClicked), "Save photo failed.", ex: ex);
